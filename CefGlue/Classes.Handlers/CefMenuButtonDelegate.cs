namespace Xilium.CefGlue
{
    ...
    /// class carries the CefViewDelegate slots (via CefButtonDelegate) directly.)
    /// </summary>
    public abstract unsafe partial class CefMenuButtonDelegate
    {
        ...
        {
            CheckSelf((cef_menu_button_delegate_t*)self);
            OnButtonPressed(CefButton.FromNative(button));
        }
        ...
        {
            CheckSelf((cef_menu_button_delegate_t*)self);
            OnButtonStateChanged(CefButton.FromNative(button));
        }
        ...
        private void on_menu_button_pressed(cef_menu_button_delegate_t* self, cef_menu_button_t* menu_button, cef_point_t* screen_point, cef_menu_button_pressed_lock_t* button_pressed_lock)
        {
            ...
            OnMenuButtonPressed(CefMenuButton.FromNative(menu_button), m_point, CefMenuButtonPressedLock.FromNative(button_pressed_lock));
        }
